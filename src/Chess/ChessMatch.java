...
public class ChessMatch {
    ...
    private List<Piece> piecesOnTheBoard = new ArrayList<>(); // essas 2 listas não são as listas que aparecem no terminal,
    private List<Piece> capturedPieces = new ArrayList<>(); // as que aparecem no terminal estão na UI
